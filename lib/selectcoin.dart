...
import 'package:fx_journal/chartmodal.dart';
...
class SelectCoin extends StatefulWidget {
  ...
  SelectCoin({this.selectItem,required this.id});
    ...
    return SafeArea(
      ...
      body: Container(
        ...
        child: Column(
          ...
          Navigator.push(
              context, MaterialPageRoute(builder: (contest) => CoinList(id:widget.id,)));
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              'Ever had that sinking feeling when you realize your Bitcoin stash has gone missing? Yeah, that’s me. But for more unfortunate souls, like yours truly, the experience of losing 34,000 BTC was like misplacing your favorite pair of socks, only a tad more valuable.',
                          ...
                          Container(
                            ...
                            child: CircleAvatar(
                              ...
                              backgroundImage:
                                  AssetImage('assets/images/fx_logo_round.png'),
                            ),
                          )
                        ],
                      ),
